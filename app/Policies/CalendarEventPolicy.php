...
class CalendarEventPolicy
{
    ...
    {
        return $user->hasPermissionTo('calendar-events.read');
    }
    ...
    {
        return $user->hasPermissionTo('calendar-events.create');
    }
    ...
    {
        return $user->hasPermissionTo('calendar-events.update');
    }
    ...
    {
        return $user->hasPermissionTo('calendar-events.delete');
    }
