...
const deleteRole = () => {
    router.delete(route("roles.destroy", itemToDelete.value), {
        onFinish: () => {
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <ConfirmDialog
            ...
            type="danger"
            title="Eliminar Grupo de Permissões"
            message="Tens a certeza que desejas eliminar este grupo de permissões?"
