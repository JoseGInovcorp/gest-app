...
const submit = () => {
    ...
    form.post(route("calendar-event-types.store"));
};
</script>

<template>
    <Head title="Adicionar Tipo de Evento" />
            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400">
                        Criar novo tipo de evento para o calendário
                    </p>
                </div>
            </div>
        </div>
            ...
            >
                <div class="p-6">
                    <div class="mb-6">
                        ...
                        >
                            Preencha os dados do novo tipo. Campos obrigatórios
                            marcados com *
                        </p>
                    </div>
                ...
                >
                    ...
                    >
                        {{ form.processing ? "A guardar..." : "Guardar Tipo" }}
                    </Button>
                </div>
            </div>
        </form>
