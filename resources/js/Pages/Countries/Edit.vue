...
const form = useForm({
    ...
    name_en: props.country.name_en || "",
    iso3: props.country.iso3 || "",
    numeric_code: props.country.numeric_code || null,
    phone_prefix: props.country.phone_prefix || "",
    vies_enabled: props.country.vies_enabled,
...
const submit = () => {
    ...
    form.transform((data) => ({
        ...
        currency_code: data.currency_code
            ...
            : null,
    })).put(route("countries.update", props.country.code));
};
</script>
                    ...
                    >
                        <div class="p-6">
                            <div class="mb-6">
                                ...
                                >
                                    Atualize os dados do país. Campos
