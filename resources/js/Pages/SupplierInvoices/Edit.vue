...
// Inicializar encomendas filtradas
if (form.supplier_id) {
                    ...
                    <form @submit.prevent="submit" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                readonly
                                class="w-full rounded-md border-gray-300 bg-gray-100 dark:bg-gray-900 dark:border-gray-600 dark:text-white cursor-not-allowed"
                            />
                        </div>
                        ...
                        <div>
                            <label
                                ...
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
                            >
                                Atualizar Documento (PDF, JPG, PNG - máx 5MB)
                            </label>
                            <input
                                type="file"
                                id="documento"
