...
const submit = () => {
    ...
    form.post(route("calendar-event-actions.store"));
};
</script>

<template>
    <Head title="Adicionar Ação de Evento" />
    ...
    <AuthenticatedLayout>
            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400">
                        Criar nova ação para eventos do calendário
                    </p>
                </div>
            </div>
        </div>
        ...
        <nav class="mb-6">
            ...
            >
                ...
                <li>/</li>
                <li class="text-gray-900 dark:text-white">Adicionar</li>
            </ol>
        </nav>
            ...
            >
                <div class="p-6">
                    <div class="mb-6">
                        ...
                        >
                            Preencha os dados da nova ação. Campos obrigatórios
                            marcados com *
                        </p>
                    </div>
                ...
                >
                    ...
                    >
                        {{ form.processing ? "A guardar..." : "Guardar Ação" }}
                    </Button>
                </div>
            </div>
        </form>
