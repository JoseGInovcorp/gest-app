<template>
    ...
    <AuthenticatedLayout>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <select
                            ...
                            @change="search"
                            class="h-10 px-6 py-2 pr-12 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                        >
        ...
        <ConfirmDialog
            ...
            message="Tens a certeza que desejas eliminar este artigo?"
...
const deleteArticle = () => {
    router.delete(route("articles.destroy", itemToDelete.value), {
        preserveState: true,
        onFinish: () => {
