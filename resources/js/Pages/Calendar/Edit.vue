...
const form = useForm({
    ...
    calendar_event_type_id: props.event.calendar_event_type_id,
    calendar_event_action_id: props.event.calendar_event_action_id,
    event_date: props.event.data,
    event_time: props.event.hora,
    duracao: props.event.duracao,
    partilha: props.event.partilha,
    shared_with: props.event.shared_with_ids || [],
    conhecimento: props.event.conhecimento || "",
    descricao: props.event.descricao || "",
    estado: props.event.estado,
});
...
const submit = () => {
    ...
    form.transform(() => data).patch(
        route("calendar-events.update", props.event.id)
    );
};
</script>
    ...
    <AuthenticatedLayout>
        ...
        <nav class="mb-6">
            ...
            >
                ...
                <li>/</li>
                <li class="text-gray-900 dark:text-white">Editar Evento</li>
            </ol>
        </nav>

        <div class="mb-4">
            <Link :href="route('calendar-events.show', event.id)">
