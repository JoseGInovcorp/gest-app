...
const form = useForm({
    nome: props.account.nome,
    banco: props.account.banco,
    iban: props.account.iban,
    swift_bic: props.account.swift_bic,
    saldo_inicial: props.account.saldo_inicial,
    moeda: props.account.moeda,
    tipo: props.account.tipo,
    estado: props.account.estado,
    observacoes: props.account.observacoes,
});
