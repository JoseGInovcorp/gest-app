        ...
        <div class="space-y-6">
            ...
            >
                <Form @submit.prevent="handleSubmit">
                    ...
                    <!-- Validação visual -->
                    <div v-if="!isFormValid" class="rounded-lg bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 p-4">
                        <div class="flex">
                    ...
                    >
                        ...
                        <Button
                            ...
                            :class="[
                                'flex items-center space-x-2 bg-purple-600 hover:bg-purple-700 focus:ring-purple-500',
                                !isFormValid ? 'opacity-50 cursor-not-allowed' : ''
                            ]"
                        >
                            <span v-if="form.processing">A criar...</span>
                            <span v-else-if="!isFormValid">Preencha os campos obrigatórios</span>
