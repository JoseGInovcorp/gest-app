    ...
    <AuthenticatedLayout>
            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400">
                        Registar débito ou crédito na conta corrente
                    </p>
                </div>
            </div>
        </div>
        ...
        <nav class="mb-6">
            ...
            >
                ...
                <li>/</li>
                <li class="text-gray-900 dark:text-white">Novo Movimento</li>
            </ol>
        </nav>
            ...
            <form @submit.prevent="submit" class="p-6">
                ...
                >
                    ...
                    >
                        ...
                        <span v-else>Registar Movimento</span>
                    </button>
                </div>
            </form>
        </div>
...
const submit = () => {
    form.post(route("client-accounts.store"), {
        onSuccess: () => {
